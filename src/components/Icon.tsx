...
const ICON_NAMES: Record<string, string> = {
  ...
  "mingcute:frame-prev": "streamline-pixel:interface-essential-navigation-left-circle-2",
  "mingcute:frame-next": "streamline-pixel:interface-essential-navigation-right-circle-2",
  "mingcute:pause-fill": "streamline-pixel:video-movies-square-off",
  "mingcute:play-fill": "streamline-pixel:video-movies-player",
